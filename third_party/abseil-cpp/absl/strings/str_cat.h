...
// absl:google3-begin(Not shipping SimpleBtoa)
...
//
// absl:google3-begin(LegacyPrecision is internal)
...
// a `PadSpec` enum.
// absl:google3-begin(no StringPrintf in open-source release)
...
#include "third_party/abseil-cpp/absl/strings/internal/resize_uninitialized.h"
#include "third_party/abseil-cpp/absl/strings/internal/stringify_sink.h"
...
// absl:google3-begin(Not Releasing LegacyPrecision)
...
#endif  // THIRD_PARTY_ABSL_STRINGS_STR_CAT_H_