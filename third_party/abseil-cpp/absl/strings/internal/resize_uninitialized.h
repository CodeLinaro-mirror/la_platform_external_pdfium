...
// O(str->size()) in the case of precise growth.
        ...
        void STLStringReserveAmortized(string_type* s, size_t new_size) {
            ...
            if (new_size > cap) {
                ...
                // absl:google3-begin(internal plan)
                // TODO(b/175429069): change to 1.5x growth once std::string growth changes.
                // absl:google3-end
...
#endif  // THIRD_PARTY_ABSL_STRINGS_INTERNAL_RESIZE_UNINITIALIZED_H_