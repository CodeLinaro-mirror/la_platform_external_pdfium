...
#include "third_party/abseil-cpp/absl/base/internal/endian.h"
...
#include "third_party/abseil-cpp/absl/strings/ascii.h"  // absl:google3-only(Only used by SimpleItoaWithCommas, moving back to //strings)
...
// google3 callers should prefer `absl::SimpleAtoi()` for parsing base 10,
// `absl::SimpleHexAtoi()` for parsing base 16, and the family of
// `strings::safe_strto.*_base()` functions from google3/strings/numbers.h for
// parsing arbitrary bases.
// absl:google3-end
...
// absl:google3-begin(Legacy API)
        absl::Nonnull<char*> RoundTripDoubleToBuffer(double d,
                                                     absl::Nonnull<char*> buffer);
        absl::Nonnull<char*> RoundTripFloatToBuffer(float f,
                                                    absl::Nonnull<char*> buffer);
// absl:google3-end
...
#endif  // THIRD_PARTY_ABSL_STRINGS_NUMBERS_H_