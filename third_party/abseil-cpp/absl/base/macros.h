...
// absl:google3-begin(Renamed to ABSL_ARRAYSIZE() in Abseil)
...
// absl:google3-begin(clang-tidy-strip)
// Macro used to specify how an API should be deprecated. The specifications are
// provided as prototext of the devtools.cymbal.clang_tidy.LegacyApiRules
// message which is passed as a string argument to this macro. The Apis
// clang tidy check will parse the argument of this macro to add tooling to warn
// use of deprecated Apis and suggest fixes. See
// go/clang_tidy/checks/google3-legacy-apis.md for more details.
// TODO(b/122876324): remove in favor of ABSL_CLANG_TIDY_DEPRECATED
#define ABSL_CLANG_TIDY_RENAME(...)

// Macro used to specify how an API should be deprecated. The specifications are
// provided as prototext of the devtools.cymbal.RenameDeclSpec
// message which is passed as a string argument to this macro. The Apis
// clang tidy check will parse the argument of this macro to add tooling to warn
// use of deprecated Apis and suggest fixes. See
// go/clang_tidy/checks/google3-legacy-apis.md for more details.
#if defined(__clang__) && defined(__cplusplus) && __cplusplus >= 201103L
#define ABSL_CLANG_TIDY_DEPRECATED(proto, message)  \
  [[clang::annotate("google3-legacy-apis:" proto)]] \
  __attribute__((deprecated(message)))
#endif
#ifndef ABSL_CLANG_TIDY_DEPRECATED
#define ABSL_CLANG_TIDY_DEPRECATED(proto, message)
#endif
