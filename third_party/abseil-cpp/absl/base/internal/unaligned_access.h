...
#ifndef THIRD_PARTY_ABSL_BASE_INTERNAL_UNALIGNED_ACCESS_H_
#define THIRD_PARTY_ABSL_BASE_INTERNAL_UNALIGNED_ACCESS_H_
...
#endif  // THIRD_PARTY_ABSL_BASE_INTERNAL_UNALIGNED_ACCESS_H_