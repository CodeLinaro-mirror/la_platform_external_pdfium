...
// absl:google3-begin(unreleased macro)
...
// absl:google3-begin(google3-crosstool-msan)
#elif defined(MEMORY_SANITIZER)
// The MEMORY_SANITIZER macro is provided by the google3 Crosstool.
// Internal users may want to prefer the Crosstool macro, since it is available
// even when Abseil headers haven't been included.
...
// absl:google3-begin(google3-crosstool-tsan)
#elif defined(THREAD_SANITIZER)
// The THREAD_SANITIZER macro is provided by the google3 Crosstool.
// Internal users may want to prefer the Crosstool macro, since it is available
// even when Abseil headers haven't been included.
...
// absl:google3-begin(google3-crosstool-asan)
#elif defined(ADDRESS_SANITIZER)
// The ADDRESS_SANITIZER macro is provided by the google3 Crosstool.
// Internal users may want to prefer the Crosstool macro, since it is available
// even when Abseil headers haven't been included.
...
// The HWADDRESS_SANITIZER macro is provided by the google3 Crosstool.
// Internal users may want to prefer the Crosstool macro, since it is available
// even when Abseil headers haven't been included.
...
// absl:google3-begin(google3-crosstool-dfsan)
// The DATAFLOW_SANITIZER macro is provided by the google3 Crosstool.
// Internal users may want to prefer the Crosstool macro, since it is available
// even when Abseil headers haven't been included.
// absl:google3-end
...
// use -DLEAK_SANITIZER.
// absl:google3-begin(google3-crosstool-asan)
// The LEAK_SANITIZER macro is provided by the google3 Crosstool.
// Internal users may want to prefer the Crosstool macro, since it is available
// even when Abseil headers haven't been included.
// absl:google3-end
