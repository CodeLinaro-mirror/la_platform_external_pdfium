...
//       landing, syd);
//
// absl:google3-begin(internal go links)
// Learn the fundamental concepts of time programming at
// http://go/time-fundamentals
// absl:google3-end
...
#include "third_party/abseil-cpp/absl/time/civil_time.h"
#include "third_party/abseil-cpp/absl/time/internal/cctz/include/cctz/time_zone.h"
...
// absl:google3-begin(internal links/go links)
//
// See google3/util/time/protoutil.h for use with the One Platform (go/api)
// protos.
// absl:google3-end
    class Duration {
    public:
...
// absl:google3-begin(Keeping old signature in public API for now)
...
//
// absl:google3-begin(internal go links)
// The combination of a granularity and a starting point is called a "time
// scale", and Google code uses a variety of time representations that employ
// different time scales
// (see http://go/time-scales for a detailed overview).
// absl:google3-end
//
...
// really specifying a Civil Time and should look at the section on command-line
// flags in go/civil-time.
// absl:google3-end
//
...
// absl:google3-begin(internal go links)
// - http://go/basetime-zoneinfo for information about packaging the
...
// absl:google3-begin(internal go links)
// See http://go/avoid-google-standard-time.
// absl:google3-end
...
//
// absl:google3-begin(internal go links)
// Note: For i18n-safe formatting see the APIs recommended at
// http://go/dates-times.
// absl:google3-end
...
//
// absl:google3-begin(internal go links)
// Note: For i18n-safe parsing see the APIs recommended at
// http://go/date-parsing.
// absl:google3-end
...
#endif  // THIRD_PARTY_ABSL_TIME_TIME_H_